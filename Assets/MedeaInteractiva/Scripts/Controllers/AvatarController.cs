...
public class AvatarController : BaseController
{
   ...
   private void AvatarRetate()
   {
      ...
      {
         ToolBox.PlayAvatar(_avatarMarcela,  40f, 59f, _avatarMarcela._matAvatar, () => BaseSceneController.Instance.ChangeState(UIState.ModalIntro));
      });
   }
   ...
   private void AvatarIntro()
   {
      ToolBox.SimpleFade(0, .5f, _baseView.GetCanvasGroup(), () =>
      {
         ToolBox.PlayAvatar(_avatarMarcela,  0f, 16f, _avatarMarcela._matAvatar, MateoEntrance);
      });
   }
   ...
   private void AvatarExit()
   {
      ToolBox.SimpleFade(0, .5f, _baseView.GetCanvasGroup(), () =>
      {
         ToolBox.PlayAvatar(_avatarMateo,  23f, 37f, _avatarMateo._matAvatar,() =>
         {
   ...
   {
      ToolBox.PlayAvatar(_avatarMateo, 15f, 23, _avatarMateo._matAvatar, ()=> BaseSceneController.Instance.ChangeState(UIState.Cinematic));
   }
