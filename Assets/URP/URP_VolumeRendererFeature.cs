...
public sealed class URP_VolumeRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        URP_VolumeVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<URP_VolumeVolumeComponent>();
